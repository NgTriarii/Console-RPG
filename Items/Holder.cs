...
public class Holder : Item, IItemContainer
{
    public List<Item> Slots { get; } = new List<Item>();
    public int MaxSlots { get; }

    public Holder(int maxSlots) 
    { 
        MaxSlots = maxSlots; 
    }

    public override string Name => $"Holder ({Slots.Count}/{MaxSlots} slots)";
    ...
    public override int Equip(Player player, Item context = null)
    {
        if (context == null)
        {
            if (player.RightHand == null)
            {
                ...
                // Propagate equip to all slotted items
    ...
    public override void Unequip(Player player, Item context = null)
    {
        ...
        // Propagate unequip to all slotted items
